...
if(($name != null) && ($pwd != null) && ($cpwd != null) )
{
    if($num==0)
    {
        if($pwd==$cpwd)
        {
                mysqli_query($conn,"INSERT INTO ACCOUNTS VALUES('$name','$pwd','ACTIVE') ");
...
<body>
    ...
    <!-- <div class = "write" id="write" >
      ...
      <div class= "container">
       ...
       <input type="submit" value ="Sign in" class="btn"></form><button  class="btn" onClick="fn()" id="btn2"><<</button>
